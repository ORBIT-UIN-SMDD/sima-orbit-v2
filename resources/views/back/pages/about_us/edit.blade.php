...
@section('content')
    <div id="kt_content_container" class="container-xxl">
        <form id="kt_form" class="form d-flex flex-column flex-lg-row"
            action="{{ route('back.about-us.update', $data->id) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
                    ...
                    <div class="card-body text-center pt-0">
                        <style>
                            .image-input-placeholder {
                                background-image: url('{{ $data->getImage() ?? asset('back/media/svg/files/blank-image.svg') }}');
                            }

                            [data-bs-theme="dark"] .image-input-placeholder {
                                background-image: url('{{ $data->getImage() ?? asset('back/media/svg/files/blank-image-dark.svg') }}');
                            }
                        </style>
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-5">
                            ...
                            <input type="number" name="order" class="form-control form-control-solid"
                                placeholder="Urutan tampil" value="{{ old('order', $data->order) }}" min="0" />
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-5 mt-5">
                            ...
                            <input type="text" name="name" class="form-control form-control-solid mb-3"
                                placeholder="Judul atau nama" value="{{ old('name', $data->name) }}" required />
                            @error('name')
