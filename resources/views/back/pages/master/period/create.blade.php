...
@section('content')
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div id="kt_app_content_container" class="app-container container-xxl">
            <form class="form" action="{{ route('back.master.period.store') }}" method="POST">
                @csrf
                    ...
                    <div class="card-body pt-0">
                        <div class="row">
                            <div class="col-md-12 mb-5 fv-row">
                                ...
                                <input type="text" name="name" class="form-control mb-2"
                                    placeholder="Contoh: Periode 2024-2025" value="{{ old('name') }}" required />
                                @error('name')
                        ...
                        <div class="mb-5 fv-row">
                            ...
                            <textarea name="description" class="form-control mb-2" rows="4"
                                placeholder="Deskripsi periode (opsional)">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="text-danger fs-7">{{ $message }}</div>
                            @enderror
                        </div>
