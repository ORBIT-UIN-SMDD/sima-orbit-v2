                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('back.master.user.edit', $user->id) }}"
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <div class="modal-content">
                    ...
                    <div class="modal-body px-5">
                        <form class="form" method="POST" action="{{ route('back.master.user.destroy', $user->id) }}">
                            @method('DELETE')
                            @csrf
                    ...
                    <div class="modal-body">
                        <div class="form-group mb-3">
                            ...
                            <small>File Excel Harus Sesuai Dengan Format Yang Telah Disediakan <br>
                                <a href="{{ asset('file_ext/guru_import_template.xlsx') }}" class="text-primary">Download
                                    Format
                                    Excel</a>
                            </small>
