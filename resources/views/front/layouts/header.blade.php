                         ...
                         <li class="nav-item dropdown dropdown-with-icon-style02">
                             ...
                             <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                 @foreach ($category_news as $category)
                                     <li><a href="{{ route('news.category', $category->slug) }}"><i
                                                 class="bi bi-briefcase"></i>{{ $category->name }}</a></li>
                                 @endforeach
             ...
             <div class="col-auto col-xxl-3 col-lg-2 text-end d-none d-sm-flex">
                 <div class="header-icon">
                     <div class="header-button">
                         <a href="#modal-popup3"
                             class="btn btn-large btn-transparent-white-light btn-rounded text-transform-none border-1 popup-with-move-anim">Login
...
<div id="modal-popup3" class="zoom-anim-dialog mfp-hide col-xl-3 col-lg-6 col-md-7 col-11 mx-auto bg-white text-center modal-popup-main p-50px">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mb-3 text-start">
            <input type="text" class="form-control" id="login" name="login" placeholder="NIM/Email" required autofocus>
        </div>
        <div class="mb-3 text-start">
        ...
        <button type="submit" class="btn btn-dark-gray btn-rounded w-100">Login</button>
    </form>
</div>
